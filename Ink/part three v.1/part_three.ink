...
== blueThink3 == 
+ [(Is this the end? Is it going to end now? This is it? No.. No..)] -> blueThink4
...
== blueThink8 == 
+ [(Man.. What is this rush of hatred and outrage I'm feeling! I can't handle it. And I can't hide it. I can't. I need to let it out. But it will literally ruin everything we have and end it for good!)] -> blueThink9

== blueThink9 == 
+ [(I don't want that to happen.. At least not now..)] -> blueThink10

== blueThink10 == 
+ [(Okay.. Got it.. I'll just text him..)] -> blueThink11
...
+ [("Can you take a step back and tell me what's happening in your mind first? Might be false..")] -> next1
...
+ [(What!! I did eat it!!! What does she mean?!! I need to call her for clarification)] -> next2

== next2 ==

+ [*Incoming call from Purple*]  -> nextBonus1

== nextBonus1 ==
+ [(Why isn't she picking up? Is it possible she's not receiving my call?)] -> next3
...
+ [(She's ignoring me, which means she's really pissed at something! I need to calm her down and explain carefully)] -> nextBonus2

== nextBonus2 ==

When you thought I didn't eat your dessert, and then I told you it's my roommate who didn't eat his portion #CLASS: purple

+ [(She's not typing.. Ah.. I know cooking food is very special to her and I hate to make her feel bad..)] -> nextBonus3
...
+ [(What!! Why is she talking to me like this?? I'm very very bothered that she really thought I didn't eat it!)] -> next4
-> DONE
...
+ [(Okay now I'm starting to lose it. And before I make any assumptions, I want to make sure that she's really serious.)] -> nextBonus4
...
+ [(Oh my god.. What's happening? "I’m really irritated, and she said "Good", which made me more upset!")] -> nextBonus5

== nextBonus5 == 

I’m really irritated, and you said "Good", which made me more upset #CLASS: purple

+ [(I need to call her. This is very bizarre!)] -> next5

== next5 ==

+ [(*Incoming call from Purple*)] -> nextBonus55

== nextBonus55 ==
+ [(Is she receiving my calls or what?)] -> next6
...
+ [(I can't get anything from her via texting. I really need to call her.)] -> nextBonus6
...
+ [*10 min later..*] -> nextBonus6

-> nextBonus6

== nextBonus6 == 

+ [(I don't understand. She never ignores me like this. And it's making me feel really really mad. But I shouldn't show it. I'm trying to help.)] -> nextBonus7
...
+ [(She's hiding something. It's definitly not about the fridge. Something important happened and I can't ignore that.)] -> nextBonus7
...
+ [(She's trying to escape. I won't let that happen. I need to know! Take a deep breath Purple and carefully and clearly explain the situation.)] -> next8
-> DONE
...
+[(Was I intense? I'm just trying to be clear and straightforward cuz I really care about her.. I hope she talkes to me cuz it's unhealthy to ignore that..)] -> next88
...
+ [("Not true. The more abrupt and short talks the more I get upset")] -> next9
...
+ [(This is gonna be hard. I need to make it easier and doable for her.)] -> next99
...
+ ["God.. I'm literally shaking.. She's so intense.. Could it be when she entered the apartment she saw the..? No.. It can't be.."] -> nextBonus8
...
+ [(Letting go was never a good solution. It's unhealthy. Besides, "I don't think I would be able to sleep if I didn't clear that.")] -> next10
...
+ [(Ah.. I'm tired of her diversions.. I don't give a shit about my feelings now because I need to know what's happening in her head before I make any mistakes!)] -> nextBonus9
...
+ [(Given the fact this is the first time she acts like this in our relationship, it's very hard. Besides, I'm starting to get scared that she's not really mad because of the fridge..)] -> nextBonus10
...
+ [(I truly beleive we can't solve this without talking about it. Even if it turns out she saw it, I can't make sure of that before confirming.)] -> next11
...
+ [(Does she care about me..?)] -> next12

== next12 ==
Don't you dare saying that I don't care about you! I'm doing this because I care about you!! #CLASS: blue

+ [(I got her mad. This is not good. One of us should stay calm to balance the sitaution. I will take a deep breath and explain that maybe this is just misunderstanding and talking should clear things up..)] -> next112
...
+ [(Ah.. I don't want this to be ruined! And I certainly can't enjoy the night knowing  she wouldnt enjoy it..)] -> next13
...
+ [(Does that mean she doesn't trust this conversation is needed to help fix our relationship?)] -> next14
...
+ [(No.. I'm not letting go of it this time. If I keep ignoring these small stuff, it will get bigger later and severely affect our relationship!)] -> next15
-> DONE
...
+ [(I hope she believes that I really care about her.. I really do..)] -> next16
-> DONE
...
+ [(Yes.. I'm reading very carefully)] -> next17
-> DONE
...
+ [(Shit.. This is escalating to a level that's making me so worried.. She's so special to me as well..)] -> next18
-> DONE
...
+ [(We really need to have this call. "I hate texting. Its emotionless. Its draining and not efficient, especially for an important conversation like this")] -> next19
-> DONE
...
+ [(She always has her ways to make me laugh..)] -> next20
-> DONE
...
+ [(Why is she so insistent on the fact this would hurt our relationship rather than fix it? "Is there anything you can ask me to make sure that won't happen?")] -> next21
-> DONE
...
+ [(Hard to agree on this. But since I beleive in the importance of this call, I'll have to allow it even if it was one sided..)] -> next22
-> DONE
...
+ ["I hope you have a good night dear.. I really do."] -> next26
...
-> END
 ...
 ______________________ End of Part 2 ______________________
